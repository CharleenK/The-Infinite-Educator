    ...
    <>
      ...
      <StyledDiv1>
        <StyledDiv2>
          ...
          <StyledDiv3>
            <p>
              ...
              professionals through comprehensive support, proactive advocacy
              and responsive listening strategies. Our core commitments include
              providing targeted professional development resources,
              personalized mentoring and promote inclusive and innovative
        ...
        <StyledDiv2>
          ...
          <StyledDiv3>
            <p>
              To improve educational quality in early childhood settings.
              Empower educators with skills and knowledge and provide the early
              years community comprehensive professional growth and new
              opportunities.
            </p>
          </StyledDiv3>
        </StyledDiv2>
        <StyledDiv2>
          ...
          <StyledDiv3>
            <p>
              ...
              collaborative work environment, helping educators thrive and
              centers succeed.
            </p>
          </StyledDiv3>
          <StyledDiv3>
