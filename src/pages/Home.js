...
import brightIdea from "../images/homePagePics/brightIdea.png";
import storyTime from "../images/homePagePics/storyTime.jpg";
import playBlocks from "../images/homePagePics/playBlocks.jpg";
const Home = () => {
  return (
    <>
